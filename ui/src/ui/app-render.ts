      ...
      <main class="content ${isChat ? "content--chat" : ""}">
        ...
        ${state.tab === "chat"
          ? renderChat({
              ...
              elevenLabsVoiceInputBusy: state.chatElevenLabsVoiceInputBusy,
              elevenLabsVoiceInputEnabled: state.chatElevenLabsVoiceInputEnabled,
              voiceInputBusy: state.chatVoiceInputBusy,
              voiceInputEnabled: state.chatVoiceInputEnabled,
              ...
              onElevenLabsVoiceInput: (params) => state.handleChatElevenLabsVoiceInput(params),
              onVoiceInput: (params) => state.handleChatVoiceInput(params),
