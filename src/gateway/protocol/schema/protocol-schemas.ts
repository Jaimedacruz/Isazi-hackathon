...
export const ProtocolSchemas = {
  ...
  ChatVoiceStatusResult: ChatVoiceStatusResultSchema,
  ChatVoiceTranscribeParams: ChatVoiceTranscribeParamsSchema,
  ChatVoiceTranscribeResult: ChatVoiceTranscribeResultSchema,
